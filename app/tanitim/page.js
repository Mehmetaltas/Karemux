  ...
  return (
    <div style={{ background: C.paper, fontFamily: C.bodyFont, color: C.ink, overflowX: "hidden" }}>
      ...
      <KareliArkaplan style={{ padding: "56px 20px 64px", textAlign: "center", borderBottom: `1px solid ${C.grid}` }}>
        <Image src="/icons/icon-192.png" alt="Karemux logo" width={56} height={56} style={{ borderRadius: 14, marginBottom: 16, boxShadow: "0 4px 16px rgba(0,0,0,0.15)" }} />
      ...
      <div style={{ padding: "48px 20px 60px", textAlign: "center" }}>
        ...
        <a href="https://www.karemux.com/?uygulama=1" style={{ background: C.red, color: "#fff", padding: "14px 30px", borderRadius: 10, fontWeight: 700, fontSize: 15, textDecoration: "none", display: "inline-block" }}>Karemux'a Git →</a>
