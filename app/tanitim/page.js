  ...
  return (
    <div style={{ background: C.paper, fontFamily: C.bodyFont, color: C.ink, overflowX: "hidden" }}>
      ...
      <div style={{ padding: "48px 20px 60px", textAlign: "center" }}>
        ...
        <a href="https://www.karemux.com/" style={{ background: C.red, color: "#fff", padding: "14px 30px", borderRadius: 10, fontWeight: 700, fontSize: 15, textDecoration: "none", display: "inline-block" }}>Karemux'a Git →</a>
