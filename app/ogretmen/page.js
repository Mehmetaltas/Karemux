      ...
      <div style={{ padding: 20, maxWidth: 480, margin: "0 auto" }}>
        {sekme === "ozet" && (
          <div>
            ...
            {!twaIcindeMi && iosMu && (
              <div style={{ background: "#fff", border: `1px solid ${C.cizgi || "#E5E5EA"}`, borderRadius: 8, padding: "10px 12px", marginBottom: 20, fontSize: 12, color: C.ink || "#1D1D1F" }}>
            ...
            {!twaIcindeMi && !iosMu && (
              <a href="https://github.com/Mehmetaltas/KAREMUX/releases/download/ogretmen-apk-latest/karemux-ogretmen-imzali.apk" style={{ display: "inline-block", padding: "6px 12px", borderRadius: 6, border: `1px solid ${C.cizgi || "#E5E5EA"}`, color: C.ink || "#1D1D1F", fontSize: 11.5, fontWeight: 600, textDecoration: "none", marginBottom: 20 }}><i className="ti ti-brand-android" style={{ fontSize: 13, marginRight: 4 }} /> Uygulamayı İndir</a>
            )}
