...
export default function VeliPaneli() {
  ...
  async function havaleIleSatinAl(ogrenciId, plan) {
    ...
    if (!sozlesmeOnayli) { setHata("Devam etmek icin Mesafeli Satis Sozlesmesi'ni onaylamalisin."); return; }
  ...
  return (
    <main style={{ minHeight: "100vh", background: T.bg, padding: "24px 16px", fontFamily: "system-ui, sans-serif" }}>
      ...
      <div style={{ maxWidth: 560, margin: "0 auto" }}>
        ...
        {!twaIcindeMi && !iosMu && (
          <a href="https://github.com/Mehmetaltas/KAREMUX/releases/download/veli-apk-latest/karemux-veli-imzali.apk" style={{ display: "inline-block", padding: "6px 12px", borderRadius: 6, border: `1px solid ${T.line}`, color: T.ink, fontSize: 11.5, fontWeight: 600, textDecoration: "none", marginBottom: 12 }}><i className="ti ti-brand-android" style={{ fontSize: 13, marginRight: 4 }} /> Uygulamayı İndir</a>
        )}
