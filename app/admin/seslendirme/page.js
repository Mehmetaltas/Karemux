...
export default function SeslendirmeAdmin() {
  ...
  return (
    <div style={{ maxWidth: 600, margin: "40px auto", padding: 20, fontFamily: "system-ui, sans-serif" }}>
      ...
      <p style={{ fontSize: 13, fontWeight: 600, display: "block", marginBottom: 6 }}>Ses ID (boş bırakılırsa varsayılan kullanılır)</p>
      ...
      <p style={{ fontSize: 13, fontWeight: 600, display: "block", marginBottom: 6 }}>Dosya adı (indirirken)</p>
      <input value={dosyaAdi} onChange={(e) => setDosyaAdi(e.target.value)}
        style={{ width: "100%", padding: 10, borderRadius: 8, border: "1px solid #ccc", marginBottom: 16, fontSize: 14 }} />

      <p style={{ fontSize: 13, fontWeight: 600, display: "block", marginBottom: 6 }}>Metin</p>
      ...
      {sesUrl && (
        <div style={{ marginTop: 20, padding: 16, background: "#f5f5f0", borderRadius: 10 }}>
          {/* eslint-disable-next-line jsx-a11y/media-has-caption -- dinamik AI seslendirmesi, metni zaten ayni ekranda girilen alanda gorunur, ayri altyazi dosyasi uretilmiyor */}
