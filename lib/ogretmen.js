...
export function ogretmenOturumCookieBaslik(token, beniHatirla = true) {
  // 5 Eylul: ayni degisiklik - "Beni Hatirla" artik cerezi uzatmiyor.
  return `karemux_ogretmen_token=${token}; HttpOnly; Secure; SameSite=Lax; Path=/`;
}
