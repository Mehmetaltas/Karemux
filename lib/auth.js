...
export function oturumCookieBaslik(token) {
  ...
  return `karemux_token=${token}; Domain=.karemux.com; HttpOnly; Secure; SameSite=Lax; Path=/`;
}

export function cikisCookieBaslik() {
  return `karemux_token=; Domain=.karemux.com; HttpOnly; Secure; SameSite=Lax; Path=/; Max-Age=0`;
}
