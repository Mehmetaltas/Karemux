...
export function oturumCookieBaslik(token) {
  // httpOnly: JS ile okunamaz (XSS koruması) | Secure: sadece HTTPS | SameSite: CSRF koruması
  return `karemux_token=${token}; HttpOnly; Secure; SameSite=Lax; Path=/; Max-Age=${30 * 24 * 60 * 60}`;
}
